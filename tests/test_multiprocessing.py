...
class TestMultiprocessing:
    ...
    def test_close_connection_in_parent(self, master_host, master_port):
        """
    ...
    def test_pool(self, max_connections, master_host, master_port):
        """
